...
FROM Products_Discounted 
--5--
SELECT DISTINCT Customerame, Country
FROM Customers
--6--
...
--7--
SELECT ProductName, StockQuantity, IIF(StockQuantity > 100, 'Yes', 'No') as Stock
FROM Products_Discounted
--8--
SELECT *
FROM Products
...
SELECT 
    CASE	
	WHEN SaleAmount > 500 then 'Top Tier' WHEN SaleAmount BETWEEN 200 AND 500 then 'Mid Tier'
	 ELSE 'Low Tier'
	 END AS SaleCategory
FROM Sales
--14--
