...
WHERE O.OrderDate BETWEEN '2023-01-01' AND '2024-01-01'
--3--
...
SELECT O.OrderID,
	   ...
	   P.PaymentDate,
	   P.Amount
FROM Orders O FULL OUTER JOIN  Payments P ON O.OrderID = P.OrderID

--6--
SELECT *
FROM EMPLOYEES AS EMPS JOIN EMPLOYEES AS MANS ON EMPS.ManagerID = MANS.EmployeeID

--7--
SELECT S.[Name], C.CourseName
FROM Students AS s JOIN Enrollments AS e ON S.StudentID = E.EnrollmentID
...
--19--
SELECT E1.NAME AS EMP_NAME, E1.Salary FROM Employees e1
