...
AS BEGIN 
	...
	SELECT E.EmployeeID,
		   ...
		   E.Department,
		   E.Salary,
		   E.Salary * D.BonusPercentage / 100 AS BONUS 
	FROM Employees E INNER JOIN DepartmentBonus D ON E.Department = D.Department
...
--2--
CREATE PROC sp_UpdateSalaryByDepartment
    @Department NVARCHAR(50),
...
EXEC sp_UpdateSalaryByDepartment 
    @Department = 'Sales', 
...
MERGE INTO Products_Current TARGET 
