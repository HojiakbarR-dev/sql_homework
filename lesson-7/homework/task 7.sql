...
--5--
SELECT SUM(ProductID) FROM Sales
WHERE ProductID = 7
--6--
SELECT AVG(Age) FROM Employees
--7--
SELECT DepartmentName, COUNT(*) EMP_COUNT FROM Employees
...
GROUP BY CustomerID
--10--
SELECT DepartmentName, COUNT(*) as EmpCount from Employees
GROUP BY DepartmentName
HAVING COUNT(*) > 5

--11--
SELECT SUM(SaleAmount) AS TotalAmount, AVG(SaleAmount) AS AvgAmount 
FROM Sales
GROUP BY ProductID

--12--
--SELECT * FROM Employees
SELECT DepartmentName, COUNT(EmployeeID) AS HR_Employees FROM Employees
...
--15--
SELECT DepartmentName, AVG(SALARY) AS AVG_SALARY, COUNT(*) AS EmpCount FROM Employees
GROUP BY DepartmentName
--16--
...
--17--
SELECT SaleDate, SUM(SaleAmount) AS SALES_EACH_YEAR FROM Sales
GROUP BY SaleDate
--18--
SELECT * FROM Orders
