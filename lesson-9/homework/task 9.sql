...
--2--
SELECT [NAME], DepartmentName FROM Employees, Departments
...
FROM Customers as c JOIN Orders o  ON o.CustomerID = c.CustomerID
...
--8--
SELECT s.[Name], en.CourseID
FROM Students AS s 
JOIN Enrollments as en ON s.StudentID = en.StudentID
--9--
